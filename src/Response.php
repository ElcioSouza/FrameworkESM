...
namespace src;
/**
 * @descrition: Administrar as respostas enviadas ao cliente
 */
...
class Response {
    ...
    public function setContent($content) {
        ...
        $this->content = is_string($content) ? $content : (string) json_encode($content,JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
        echo $this->content;
        return $this;
    }
